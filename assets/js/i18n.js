...
(function (window, document) {
  ...
  var dicionario = {
    pt: {
      ...
      "busca.abrir": "Buscar no cardápio",
      "busca.placeholder": "Buscar prato ou ingrediente",
      "busca.limpar": "Limpar busca",
      "busca.um": "1 resultado",
      "busca.varios": "{n} resultados",
      "busca.vazioTitulo": "Nada encontrado",
      "busca.vazioTexto": "Não achamos nenhum prato para essa busca. Tente o nome de um ingrediente, como camarão, brócolis ou picanha.",
    ...
    en: {
      ...
      "busca.abrir": "Search the menu",
      "busca.placeholder": "Search dish or ingredient",
      "busca.limpar": "Clear search",
      "busca.um": "1 result",
      "busca.varios": "{n} results",
      "busca.vazioTitulo": "Nothing found",
      "busca.vazioTexto": "We could not find any dish for that search. Try an ingredient name, such as shrimp, broccoli or picanha.",
    ...
    es: {
      ...
      "busca.abrir": "Buscar en el menú",
      "busca.placeholder": "Buscar plato o ingrediente",
      "busca.limpar": "Limpiar búsqueda",
      "busca.um": "1 resultado",
      "busca.varios": "{n} resultados",
      "busca.vazioTitulo": "Nada encontrado",
      "busca.vazioTexto": "No encontramos ningún plato para esa búsqueda. Pruebe el nombre de un ingrediente, como camarón, brócoli o picaña.",
